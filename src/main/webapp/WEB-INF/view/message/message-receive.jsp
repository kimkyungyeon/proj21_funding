...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/message_css/message-receive.css">
...
<script type="text/javascript">
	...
	function movePage(currentPage, cntPerPage, pageSize){
	    ...
	    var url = "${pageContext.request.contextPath}/message/message-receive";
...
<body>
	<div class="container">
		...
		<section id="messageFormArea">		
			...
			<div id="message">
				<h2>받은 쪽지함(${pagination.totalRecordCount})</h2>
			    ...
			    <!-- /paginate -->
				    <form:hidden path="readYN" value="True"/>
